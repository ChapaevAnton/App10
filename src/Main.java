public class Main {
    // TODO: В кафе-бургерная срочная авария - вышла из строя линия готовки гамбургеров,
    //  только Вам под силу решить эту проблему!!!! Шеф повар в панике!!! ААААААААА!!!!
    //  Задание - не изменяя состав рецептов, параметры методов создания и
    ...
    //  4.Постарайтесь выполнить практическое задание не прибегаю к кардинальному изменению классов: Hamburger, HamburgerMaker, Oven, Food.
    //  Удачи!!!
